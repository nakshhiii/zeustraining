function generateOptions(list) {
    ...
    for (var _i = 0, list_1 = list; _i < list_1.length; _i++) {
        ...
        if (typeof item === 'string') {
            ...
            // Check if item is an object with 'value' and 'label' properties
            res += "<option value=\"".concat(item.value, "\">").concat(item.label, "</option>");
        }
    }
    return res;
}
var renderCard = function () {
    ...
    fetch("/zeustraining/quantumlogin/dashboardjs/script/data.json")
        ...
        .then(function (datalist) {
            // Now we have the data, so proceed with rendering
